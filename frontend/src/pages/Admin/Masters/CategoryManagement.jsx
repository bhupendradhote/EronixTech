...
const CategoryManagement = () => {
  ...
  const saveCategory = async () => {
    ...
    try {
      if (editingCategory) await categoryService.updateCategory(editingCategory.id, dataToSend);
      else await categoryService.createCategory(dataToSend);
  ...
  const toggleActive = async (category) => {
    try {
      ...
      await categoryService.updateCategory(category.id, dataToSend);
      fetchCategories();
    } catch (error) {
      console.error(error);
    }
        ...
        <div className="master-form-section">
          ...
          <div className="form-body">
            <div className="form-group">
              <label>Name *</label>
              <input type="text" name="name" value={formData.name} onChange={handleInputChange} className="form-input" placeholder="e.g., Electronics" />
            </div>
